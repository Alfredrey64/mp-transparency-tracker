...
const PROCEDURE_TERMS = [
  ...
  { term: "Backbench Business Committee", def: "A cross-party Commons committee that decides what backbenchers — rather than the government or opposition — get to debate on the days set aside for them. Its members and chair are elected by the whole House, with the chair by long-standing convention (though not by rule) coming from the opposition benches." },
  ...
  { term: "Black Rod", def: "The Lords official who summons MPs to hear the King's Speech — traditionally having the Commons' door shut in their face en route, symbolising the Commons' independence from the monarch. Formally appointed by the Monarch, usually a retired senior military officer, and holds the post for several years as a salaried Lords official rather than a one-off ceremonial part." },
  ...
  { term: "Committee Stage", def: "Detailed, line-by-line examination of a bill — usually by a Public Bill Committee of around 16–50 MPs, sized and party-balanced to roughly mirror the Commons as a whole. Its members aren't elected: the Committee of Selection assigns them from each party's whips' nominations, so the governing party holds a majority on it too, and the minister and shadow minister in charge of the bill are typically both included." },
  ...
  { term: "King's Consent", def: "A convention requiring the monarch's consent be sought before Parliament debates a bill touching the Crown's own interests or prerogative powers — distinct from Royal Assent, which comes only at the very end. In practice it's the government department in charge of the bill that requests it on the King's behalf, well ahead of the relevant debate; the monarch doesn't personally weigh in on the decision." },
  ...
  { term: "Leader of the House", def: "The Cabinet minister responsible for organising government business in the Commons and representing the government's interests on procedural matters — appointed by the Prime Minister, like any other Cabinet post." },
  { term: "Leader of the Opposition", def: "The leader of the largest party not in government. Parliament plays no part in choosing this role: whoever that party's own internal rules produce as its leader automatically becomes Leader of the Opposition, which then comes with formal recognition — a salary, and by tradition a prominent slot at PMQs." },
  ...
  { term: "Lord Chancellor", def: "A Cabinet minister with historic responsibility for the courts and judiciary, appointed by the Prime Minister like any other Cabinet post. Before 2006 the role also doubled as Speaker of the House of Lords, and unlike most ministers was traditionally always a senior lawyer or judge sitting as a peer — a requirement dropped in reforms that year, so the role can now go to an MP with no legal background." },
  { term: "Lord Speaker", def: "The presiding officer of the House of Lords, chairing its sittings — the Lords' equivalent of the Commons Speaker. Elected by secret ballot of all members of the Lords. The role itself is fairly new, created in 2006 to separate it from the Lord Chancellor, who had presided over the Lords for centuries before that." },
  ...
  { term: "Money Resolution", def: "A Commons motion authorising a bill to involve new public spending. Without one, a bill with a spending implication can't proceed to its later stages — and only a government minister can move one, so a Private Member's Bill with a spending implication is effectively at the government's mercy on this point." },
  ...
  { term: "Private Member's Bill", def: "A bill introduced by an MP who isn't a government minister — much less likely to become law than a government bill, given how little time is set aside for them. Most get their shot at that time one of three ways: a handful of names drawn at random in a ballot held near the start of each session (the best real chance of debate time), a Ten Minute Rule slot claimed on a first-come-first-served basis, or simply being formally \"presented\" — the least likely route of the three to ever get debated at all.", example: "The Terminally Ill Adults (End of Life) Bill, on assisted dying, began this way in 2024." },
  ...
  { term: "Public Bill Committee", def: "The committee that carries out a bill's Committee Stage in the Commons, examining its text clause by clause and considering amendments. Members are chosen by the Committee of Selection from whips' nominations rather than elected, sized to roughly reflect each party's strength in the Commons — so the governing party has a majority on it too." },
  ...
  { term: "Select Committee", def: "A cross-party group of MPs (or peers) that scrutinises a specific government department or policy area in detail, and publishes reports. Since 2010, members are elected by secret ballot of the whole House, and each chair is elected by the whole House too — though which party gets to hold a given chair is fixed in advance by an agreed formula reflecting party strength, so the vote is only ever between candidates from that party.", example: "The Treasury Select Committee questions the Chancellor and Bank of England on economic policy." },
  { term: "Speaker", def: "The MP elected to chair Commons proceedings and enforce its rules impartially — chosen by a secret ballot of the whole House, run as a series of exhaustive votes until one candidate has a majority. By convention they give up active party campaigning once elected, including standing for re-election simply as \"the Speaker seeking re-election\" rather than under a party label." },
  { term: "Standing Order", def: "A permanent, written rule governing how Parliament conducts its business." },
  { term: "Statutory Instrument", def: "A form of secondary legislation letting ministers make detailed law under powers an Act has already granted them, without needing a full new bill. Laid under one of two procedures: \"negative\" (it automatically becomes law unless MPs actively vote to reject it within 40 sitting days — the fate of most SIs) or \"affirmative\" (it needs an active vote of approval from Parliament before it can take effect at all, reserved for more significant powers).", example: "Most Covid-19 lockdown regulations were introduced this way, under powers in the Public Health Act 1984." },
  ...
  { term: "Ten Minute Rule Bill", def: "A brief opportunity for a backbench MP to make the case for a new bill in a ten-minute speech. The slot is claimed on a first-come-first-served basis — MPs sign up for it, rather than being chosen by ballot. Rarely becomes law, but can raise an issue's profile." },
  { term: "The Usual Channels", def: "Informal shorthand for negotiations between government and opposition whips to agree how parliamentary business and time gets arranged. In practice this means the government and opposition Chief Whips, and their deputies, dealing with each other directly and privately — the substance of it is never itself debated on the floor of the House." },
  ...
  { term: "Whip", def: "Both an instruction from a party telling its MPs how to vote (a \"three-line whip\" is the strongest), and the party official who enforces it. Whips are appointed directly by the party leader, not elected by MPs — in government, the most senior ones hold formal ministerial titles of their own (the Government Chief Whip is officially the Parliamentary Secretary to the Treasury)." },
